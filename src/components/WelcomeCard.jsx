			...
			<div className="flex flex-col md:flex-row items-center md:justify-between gap-4">
				...
				<div className=" font-tajawal px-5">
					...
					<div className="mt-4 space-x-2 space-x-reverse">
						...
						<button className="border hidden border-[#227099] text-[#227099] py-2 px-4 rounded-lg hover:bg-blue-100 transition"><i class="fa-solid fa-right-from-bracket"></i></button>
					</div>
				</div>
			</div>
		</div>
