...
function TableButton({ theme, children, style = "", ...props }) {
  let themeClass =
    "p-2 rounded duration-300 hover:text-white text-sm flex-1 font-tajawal";
  ...
  return (
    <button className={themeClass + " " + style} {...props}>
      {children}
    </button>
  );
}
