...
const FileUploader = ({ url, type }) => {
  ...
  return (
    <div className="h-full w-full flex font-tajawal font-bold flex-col items-center">
      <div
        onClick={(e) => {
      ...
      >
        ...
        {!file && (
          <label className="text-center font-semibold text-gray-600 transition-all cursor-pointer">
            <span className="block font-[24px]   text-gray-500">
              Create
            </span>
          </label>
        )}
        ...
        <input
          ...
          accept={type === "img" ? "image/*" : "*"} // Accept only images if type is "img"
        />
